...
import {
  searchItems,
  listAllItems,
  listItemsForVisibility,
  getItemDetail,
  getItemsByCategory,
  previewMasterItemImport,
  importMasterItems,
...
app.post("/api/data-explorer/bulk-delete", requireMaster, async (req, res) => {
...
// ==========================================
// 8b. MASTER ITEM PER CABANG
// Source of truth for item code -> name/kategori per cabang, master-only.
// Sales import (above) only matches against this list, never redefines it.
// ==========================================
...
app.get("/api/settings/master-items/summary", requireMaster, async (_req, res) => {
  try {
