  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-2 border-b border-border/60">
        <div>
          <h1 className="text-lg font-bold tracking-tight text-foreground">Target Penjualan Harian — Cimahi</h1>
          <p className="text-xs text-muted mt-0.5">
            Pencapaian target Server, Tartun, Petshop, Aksesoris &amp; SP/Voucher per outlet cabang Cimahi.
          </p>
        </div>
